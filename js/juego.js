...
function iniciar(){
	...
	palabras=new Array('batiz','programacion','computadora','reprobado','politecnico','burro','memoria','murcielago','objeto','clase');
	...
	agregarEvento(botonJugar,'click',function(){ location.href='juego.html';},false);
}
function jugar(e){
	if(e){
		id=e.target.id;
